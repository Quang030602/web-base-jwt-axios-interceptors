...
// Remove SvgIcon import since we're not using it properly
    ...
    <Box sx={{
      ...
      <Box sx={{
        ...
        <Typography sx={{ fontSize: '18px !important', lineHeight: '25px', fontWeight: 400, maxWidth: '350px', textAlign: 'center' }}>
          ...
          &nbsp;<Typography variant="span" sx={{ color: '#fdba26', fontWeight: 500 }}>AiMier</Typography>?<br />Hmm, looks like that page doesn&apos;t exist.
        </Typography>
        <Box sx={{ width: '390px', height: '390px', position: 'relative' }}>
          {/* Replace SvgIcon with Box component="img" */}
          <Box
            component="img"
            src={AstronautSvg}
            alt="Astronaut"
          ...
          />
          {/* This Box component="img" is correct */}
          <Box
            component="img"
            src={PlanetSvg}
            alt="Planet"
